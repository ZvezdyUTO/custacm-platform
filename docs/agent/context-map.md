...
| `platform-auth/` | Keycloak-backed auth module and the first runnable backend slice. | `platform-auth/pom.xml`, `auth-core`, `auth-interface`, `auth-web`. | [../../platform-auth/AGENTS.md](../../platform-auth/AGENTS.md) |
...
| `platform-training-data/` | Training-data Codeforces warehouse module parent. | `platform-training-data/pom.xml`, child module POMs, `platform-training-data/README.md`. | [../../platform-training-data/AGENTS.md](../../platform-training-data/AGENTS.md) |
| `platform-training-data/training-data-codeforces/` | Codeforces vertical OJ module: HTTP ingest, ingest app service, collect batch, ODS record, parser port/implementation, writer, DWD/DWM/DWS query repositories/services, ODS/DWD/DWM/DWS DDL, SQL task resources, fixture, config, and tests. DWS stores one handle/date row with fixed rating count columns. Java code is split into `app/service`, `app/result`, `domain/model`, `domain/value`, `domain/criteria`, `domain/parser`, `domain/repo`, `infra/parser`, `infra/repo`, `web/controller`, and `web/response`. | `training-data-codeforces/src/main/java/com/custacm/platform/trainingdata/codeforces`, module resources. | [../../platform-training-data/AGENTS.md](../../platform-training-data/AGENTS.md), [../../platform-training-data/training-data-codeforces/README.md](../../platform-training-data/training-data-codeforces/README.md), [../../platform-training-data/docs/ods-submission.md](../../platform-training-data/docs/ods-submission.md) |
| `platform-training-data/training-data-web/` | Spring Boot training-data warehouse runtime: ODS ingest, module health/info, security, Flyway migration, datasource config, and Logback file logging config. | `TrainingDataWebApplication.java`, controllers under OJ modules, `application.yml`, `logback-spring.xml`. | [../../platform-training-data/AGENTS.md](../../platform-training-data/AGENTS.md), [../logging.md](../logging.md) |
...
- Training-data currently implements Codeforces as a vertical OJ warehouse module with ODS, DWD, DWM, and DWS tables, SQL task resources, UTC+8 warehouse time semantics, and internal Java DWD/DWM/DWS query support. DAG/pipeline orchestration, Java SQL-task execution, HTTP warehouse query APIs, and ADS remain future work.
