...
| `platform-training-data/` | Training-data ODS warehouse module parent. | `platform-training-data/pom.xml`, child module POMs, `platform-training-data/README.md`. | [../../platform-training-data/AGENTS.md](../../platform-training-data/AGENTS.md) |
| `platform-training-data/training-data-codeforces/` | Codeforces vertical OJ module: HTTP ingest, ingest app service, collect batch, ODS record, parser, writer, DDL, upsert SQL, fixture, config, and tests. | `training-data-codeforces/src/main/java/com/custacm/platform/trainingdata/codeforces`, module resources. | [../../platform-training-data/AGENTS.md](../../platform-training-data/AGENTS.md), [../../platform-training-data/docs/ods-submission.md](../../platform-training-data/docs/ods-submission.md) |
| `platform-training-data/training-data-web/` | Spring Boot training-data ODS ingest runtime, module health/info, security, Flyway migration, datasource config, and Logback file logging config. | `TrainingDataWebApplication.java`, controllers under OJ modules, `application.yml`, `logback-spring.xml`. | [../../platform-training-data/AGENTS.md](../../platform-training-data/AGENTS.md), [../logging.md](../logging.md) |
...
- Training-data currently implements Codeforces as a vertical OJ ODS module. DAG/pipeline orchestration is intentionally absent; DWD/DWS/ADS remain future work until a concrete downstream query or product workflow exists.
