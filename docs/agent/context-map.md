...
| `platform-training-data/training-data-codeforces/` | Codeforces vertical OJ module: HTTP ingest, ingest app service, collect batch, ODS record, parser, writer, ODS/DWD/DWM/DWS DDL, SQL task resources, fixture, config, and tests. | `training-data-codeforces/src/main/java/com/custacm/platform/trainingdata/codeforces`, module resources. | [../../platform-training-data/AGENTS.md](../../platform-training-data/AGENTS.md), [../../platform-training-data/docs/ods-submission.md](../../platform-training-data/docs/ods-submission.md) |
...
- Training-data currently implements Codeforces as a vertical OJ warehouse module with ODS, DWD, DWM, and DWS tables plus SQL task resources. DAG/pipeline orchestration, Java SQL-task execution, and ADS remain future work.
