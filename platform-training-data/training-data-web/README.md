...
OJ-specific controllers and warehouse logic live in vertical OJ modules such as `training-data-codeforces`; this web module runs and secures them.
...
- `TrainingDataModuleController.java` - `/health` and `/module-info`.
