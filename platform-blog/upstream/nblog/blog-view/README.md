...
| `src/views/competition/CompetitionList.vue`、`CompetitionDetail.vue` | 公开赛事紧凑规范分类筛选分页与参赛者、文章、奖项完整详情；列表页头说明文案“勇攀高峰”相对主标题轻微右移，并使用右贴边、满高低对比的比赛会场全景图，空起止年份均明确显示“不限” |
